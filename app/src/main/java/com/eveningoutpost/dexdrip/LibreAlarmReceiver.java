...
public class LibreAlarmReceiver extends BroadcastReceiver {
    ...
    private static final long segmentation_timeslice = (long) (Constants.MINUTE_IN_MS * Pref.getStringToDouble("libre_segmentation_timeslice", 4.5));
            ...
            if (mTrend.size() > 0) {
                ...
                for (GlucoseData gd : mTrend) {
                    ...
                    if (use_raw) {
                        ...
                        BgReading.bgReadingInsertFromInt(use_smoothed_data ? gd.glucoseLevelSmoothed : gd.glucoseLevel * 1000, gd.glucoseLevelNoise, gd.realDate, segmentation_timeslice, true);
                    }
                }
            } else {
            ...
            if ((mHistory != null) && (mHistory.size() > 1)) {
                ...
                for (GlucoseData gd : mHistory) {
                    ...
                    if (use_raw) {
                        ...
                        BgReading.bgReadingInsertFromInt(gd.glucoseLevel * 1000, gd.glucoseLevelNoise, gd.realDate, segmentation_timeslice, false);
                    }
                }
